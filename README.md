...
3. "행운의 뽑기 시뮬"을 눌러 `gift.html`에서 2단계 연동 뽑기 시뮬레이션을 실행합니다.
...
현재 버전: **v1.3.32** (2025-10-07)

행운의 뽑기 시뮬레이터를 추가하고 10월 스페셜 럭키 박스 개봉 결과까지 연동했습니다.
점 처리 루프를 최적화하고 프레임 시간 측정 기능을 추가했습니다.
찬란한 여름 별빛 상자 시뮬레이터를 추가했습니다.
